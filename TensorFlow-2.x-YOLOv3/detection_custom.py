...
video_path   = "./IMAGES/SDTownCentreXVID.mp4"
...
detect_video(yolo, video_path, '', input_size=YOLO_INPUT_SIZE, show=True, CLASSES=TRAIN_CLASSES, rectangle_colors=(255,0,0)) #BGR
